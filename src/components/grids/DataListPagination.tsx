...
const DataListPagination = <T,>({
  ...
  const table = useReactTable({
    ...
    state: {
      sorting,
      pagination,
      globalFilter, // 🔑 aplicar no estado da tabela
      columnFilters,
    },
    ...
    globalFilterFn: "includesString", // 🔑 filtro simples
  ...
  if (erro) {
    return (
      <Alert
        variant="destructive"
        className="mt-4 w-full bg-red-100 text-red-800 dark:bg-red-900 dark:text-red-100 border border-red-300 dark:border-red-700"
      >
      ...
      <CardContent className="w-full h-full">
                ...
                {table.getHeaderGroups().map((headerGroup) =>
                  headerGroup.headers.map((header) => {
                    const columnMeta = header.column.columnDef
                      .meta as CustomColumnMeta | undefined;
        ...
        <div className="flex items-center justify-center mt-4 space-x-2">
          <Button
            ...
            disabled={!table.getCanPreviousPage()}> {lblanterior}
          </Button>
