...
export const InputDecimal: React.FC<EditableFieldProps> = ({
  id,
  value,
  label,
  colSpan = 1,
    ...
    <div key={id} className={colSpanClass}>
      ...
      <div className="relative h-8">
        <Input
          readOnly={readOnly}
          id={id}
          defaultValue={value ? formatDecimal(value) : ""}
          className={`!text-xs py-1 border ${
            error ? "border-red-500" : "border-gray-300 dark:border-gray-700"
          } bg-gray-100 dark:bg-gray-600 dark:text-white rounded-t rounded-b h-8 
