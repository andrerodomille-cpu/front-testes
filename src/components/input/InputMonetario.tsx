...
export const InputMonetario: React.FC<EditableFieldProps> = ({
  id,
  value,
  label,
  colSpan = 1,
    ...
    <div key={id} className={colSpanClass}>
      ...
      <div className="relative h-7">
        <Input
          ...
          defaultValue={Number.isFinite(value) ? formatCurrency(value) : ""}
          className={`h-7 !text-xs py-1 border ${error ? "border-red-500" : "border-gray-300 dark:border-gray-700"
            } bg-gray-100 dark:bg-gray-600 dark:text-white rounded-t rounded-b h-7 
